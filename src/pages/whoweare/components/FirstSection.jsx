      ...
      <div className="bg-[#f2f2f2]  flex-col md:flex md:flex-row items-center">
        ...
        <div className="basis-1/2 p-4 md:p-10">
          ...
          <p className="text-lg mt-2 tracking-wide">
            LEON is a joint venture company who is dedicated to the Cement
            ...
            Operation & Maintenance Service all over the world. <br /> LEON has
            ...
            above places. <br /> LEON are also providing sophisticated
